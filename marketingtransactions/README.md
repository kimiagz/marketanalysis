...
│                         transactionanalysis and configuration for tools like black
│
...
│
└── transactionanalysis   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes transactionanalysis a Python module
    │
